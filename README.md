# Фиксация рабочей версии (2025-04-15)

**Ветка: `stable-call-178`**  
**Ревизия Cloud Run: `talkhint-backend-00018-7gt` (или тег `stable-call-178`)**

Эта версия подтверждена как рабочая:
*   Звонок проходит (исходящий и входящий).
*   Голосовая реплика воспроизводится.
*   Нажатие клавиш (DTMF) работает.

Проверено вручную 2025-04-15.  
Использовать как контрольную точку и базу для отката перед следующими экспериментами.
